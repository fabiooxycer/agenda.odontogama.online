...
?>
          <tr>
            <td>
              <input disabled <?php echo $disable?> name="codigoprocedimento[<?php echo $row1['codigo']?>]" id="codigoprocedimento<?php echo $row1['codigo']?>" value="<?php echo $row1['codigoprocedimento']?>" type="text" class="form-control" size="10" />
            </div></td>
            <td>
              <input disabled <?php echo $disable?> name="dente[<?php echo $row1['codigo']?>]" value="<?php echo $row1['dente']?>" type="text" class="form-control" size="10" />
            </div></td>
            <td>
                <input disabled <?php echo $disable?> name="descricao[<?php echo $row1['codigo']?>]" id="descricao<?php echo $row1['codigo']?>" value="<?php echo $row1['descricao']?>" type="text" class="form-control" size="45"
            ...
            <td><div align="center">
              <input disabled <?php echo $disable?> name="particular[<?php echo $row1['codigo']?>]" id="particular<?php echo $row1['codigo']?>" value="<?php echo money_form($row1['particular'])?>" type="text" class="form-control" size="12" maxlength="10" onKeypress="return Ajusta_Valor(this, event);" />
            </td>
            <td><div align="center">
              <input disabled <?php echo $disable?> name="convenio[<?php echo $row1['codigo']?>]" id="convenio<?php echo $row1['codigo']?>" value="<?php echo money_form($row1['convenio'])?>" type="text" class="form-control" size="12" maxlength="10" onKeypress="return Ajusta_Valor(this, event);" />
            </td>
          </tr>
<?php
	}
?>
          <tr>
            <td>
              <input disabled <?php echo $disable?> name="codigoprocedimento_new" id="codigoprocedimento_new" type="text" class="form-control" size="10" />
            </div></td>
            <td>
              <input disabled <?php echo $disable?> name="dente_new" id="dente_new" type="text" class="form-control" size="10" />
            </div></td>
            <td>
              <input disabled <?php echo $disable?> name="descricao_new" id="descricao_new" type="text" class="form-control" size="45"
            ...
            <td><div align="center">
              <input disabled <?php echo $disable?> name="particular_new" id="particular_new" type="text" class="form-control" size="12" maxlength="10" onKeypress="return Ajusta_Valor(this, event);" />
            </div></td>
            <td><div align="center">
              <input disabled <?php echo $disable?> name="convenio_new" id="convenio_new" type="text" class="form-control" size="12" maxlength="10" onKeypress="return Ajusta_Valor(this, event);" />
            </div></td>
          </tr>
          <tr>
            ...
            <td><div align="center"><?php echo $LANG['general']['currency'].' '.money_form($total_particular)?>
            	<input disabled type="hidden" id="total_particular" value="<?php echo money_form($total_particular)?>"></div></td>
            <td><div align="left"><?php echo $LANG['general']['currency'].' '.money_form($total_convenio)?>
            	<input disabled type="hidden" id="total_convenio" value="<?php echo money_form($total_convenio)?>"></div></td>
          </tr>
        </table>
        <div align="right">
          <p>
        ...
        <form id="form2" name="form2" method="POST" action="pacientes/orcamentofechar_ajax.php?codigo=<?php echo $_GET[codigo]?>&acao=editar&subacao=editar&codigo_orc=<?php echo $codigo_orc?>" onsubmit="formSender(this, 'conteudo'); return false;"><br />
          <table class="table table-hover">
            ...
            <tr>
              ...
              <td>
                <div align="left">
                  <input disabled <?php echo $disable?> name="aserpago" type="radio" value="Particular" <?php echo $chk[aserpago]['Particular']?> onclick="document.getElementById('valortotal').value = document.getElementById('total_particular').value; document.getElementById('valor__total').value = document.getElementById('total_particular').value;" />
                <?php echo $LANG['patients']['private']?>
                <input disabled <?php echo $disable?> name="aserpago" type="radio" value="Convênio" <?php echo $chk[aserpago]['Convênio']?> onclick="document.getElementById('valortotal').value = document.getElementById('total_convenio').value; document.getElementById('valor__total').value = document.getElementById('total_convenio').value;" />
              <?php echo $LANG['patients']['plan']?></div></td>
              <td><div align="center">
                <input disabled <?php echo $disable?> name="valor__total" disabled type="text" value="<?php echo money_form($row[valortotal])?>" class="form-control" id="valor__total" size="15" />
                <input disabled <?php echo $disable?> name="valortotal" type="hidden" value="<?php echo money_form($row[valortotal])?>" class="form-control" id="valortotal" size="15" />
              </div></td>
              <td><div align="right">
...
?>
              ...
              <td>
                ...
                <div class="input disabled-group" style="display:flex;">
...
?>
             ...
             <input disabled <?php echo $disable?> type="text" name="entrada" value="<?php echo $row['entrada']?>" class="form-control" size="10" onkeypress="return Ajusta_Valor(this, event);">
              </td>
              <td><div><?php echo $LANG['patients']['discount']?>:
                <div class="input disabled-group" style="max-width:120px;">
                  <input disabled <?php echo $disable?> name="desconto" type="text" value="<?php echo $row[desconto]?>" class="form-control" id="desconto" style="max-width:300px;" size="5" onkeypress="return Ajusta_Valor(this, event);" />
              
              <div class="input disabled-group-btn"><button class="btn btn-default" type="button">%</button></div></div></div></div></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
              <td>&nbsp;</td>
	...
	for($i = 1; $i <= $parc; $i++) {
        ...
        if($row['entrada'] != '' && $row['entrada'] != 0 && $i === 1) {
            ...
            if($row1['pago'] != 'Sim' && $disable == 'disabled') {
                //$efetuar = '<input disabled type="submit" class="forms" name="efetuar['.$row1['codigo'].']" value="Efetuar pagamento">';
...
?>
          <tr>
    		  ...
    		  <td><div align="center">
      		    <input disabled <?php echo $disable?> name="datavencimento[<?php echo $i?>]" value="<?php echo (($row1['datavencimento'] == '-00-')?'00/00/0000':converte_data($row1['datavencimento'], 2))?>" type="text" class="form-control" size="15" />
    		    </div></td>
    		  ...
    		  <td><div align="center">
      		   <input disabled <?php echo $disable?> name="parcela[<?php echo $i?>]" value="<?php echo 'R$ '.money_form($valor)?>" type="text" class="form-control" size="15" />
    		  </div></td>
  			</tr>
<?php
	}
?>
			<tr>
  			...
  			<tr>
              <td align="left"><input disabled <?php echo $disable?> type="checkbox" <?php echo (($row['confirmado'] == 'Sim')?'checked':'')?> name="confirmed" id="confirmed" value="Sim"><label for="confirmed"> <?php echo $LANG['patients']['confirmed_budget']?></label></td>
