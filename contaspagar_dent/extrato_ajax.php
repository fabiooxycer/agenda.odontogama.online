        ...
        <td colspan="3">
          ...
          <div class="pesqProcedimento" style="width: 650px;">
            ...
            <table class="table" id="table">
              ...
              <tr>
                <td colspan="2">
                  <label>Parte da descrição</label>
                  <input type="text" id="campo" name="campo" class="form-control" placeholder="Descrição">
                </td>
              </tr>
              <tr>
                <td align="right">
  ...
  <div class="panel-body">
    ...
    if(verifica_nivel('contas_pagar', 'I')) {
      ...
      <form id="form2" name="form2" method="POST" action="contaspagar/extrato_ajax.php" onsubmit="formSender(this, 'conteudo'); this.reset(); return false;">
        ...
        <div class="panel panel-default" id="conteudo_central">
          <div class="panel-heading"><span class="glyphicon glyphicon-asterisk"></span> <b>Nova conta a pagar</b></div>
          <div class="panel-body">
            <table class="table">
              <tr>
                <td width="4%">
                ...
                <td width="12%"><?php echo $LANG['accounts_payable']['deadline']?> <br />
                  <input type="text" size="13" value="<?php echo converte_data(hoje(), 2)?>" name="datavencimento" id="datavencimento" required class="form-control">
                </td>
                <td width="58%"><?php echo $LANG['accounts_payable']['description']?> <br />
                  <input type="text" size="80" name="descricao" id="descricao" class="form-control" required>
                </td>
                <td width="16%"><?php echo $LANG['accounts_payable']['value']?> <br />
                  <input type="text" size="20" name="valor" id="valor" class="form-control" required onKeypress="return Ajusta_Valor(this, event);">
                </td>
                <td width="10%"> <br />
