...
?>
            ...
            <td><?php echo $LANG['patients']['document2']?><br />
              <input name="rg" required value="<?php echo $row[rg]?>" type="text" class="form-control" <?php echo $disable?> id="rg" /></td>
...
?>       
            ...
            <td><?php echo $LANG['patients']['ethnicity']?><br /><select name="etnia" class="form-control" <?php echo $disable?> id="etnia">
<?php
...
?>       
            ...
            <td><?php echo $LANG['patients']['naturality']?><br />
              <input name="naturalidade" required value="<?php echo utf8_encode($row[naturalidade])?>" type="text" class="form-control" <?php echo $disable?> id="naturalidade" /></td>
          
            <td><?php echo $LANG['patients']['nationality']?><br />
              <input name="nacionalidade" required value="<?php echo utf8_encode($row[nacionalidade])?>" type="text" class="form-control" <?php echo $disable?> id="nacionalidade" /></td>
            ...
            <td><?php echo $LANG['patients']['country']?><br />
                <input name="pais" required value="<?php echo utf8_encode($row[pais])?>" <?php echo $disable?> type="text" class="form-control" <?php echo $disable?> id="pais" size="30" maxlength="50" />
              <br /></td>
             </tr><tr>
            <td><?php echo $LANG['patients']['dead']?><br /><select name="falecido" class="form-control" <?php echo $disable?> id="falecido">
<?php
...
?>
            ...
            <td><?php echo $LANG['patients']['hobby']?><br />
              <input name="hobby" value="<?php echo utf8_encode($row[hobby])?>" type="text" class="form-control" <?php echo $disable?> id="hobby" size="50" /></td>
            <td><?php echo $LANG['patients']['indicated_by']?><br />
              <input name="indicadopor" value="<?php echo utf8_encode($row[indicadopor])?>" type="text" class="form-control" <?php echo $disable?> id="indicacao" /></td>
