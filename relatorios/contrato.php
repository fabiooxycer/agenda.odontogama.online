...
window.print();
    ...
    <body>
       ...
       <div id="corpo">
    	...
    	<b> <input type="text" id="" name="destista" value="<?php echo $_GET['dentista']; ?>" class="campos" style="width:607px;"/> </b> </span>
      <span ii="text">, RG</span><b><input type="text" name="rg" value=" <?php echo $_GET[rg]; ?>" id="" class="campos" style="width:263px"/></b>
      <span id="tex">CRO-UF <b> <input type="text" id="" value="<?php echo $_GET[cro]; ?>" name="cro" class="campos" style="width:215px;"/> </b> , com consultório à </span><b><input name="endereco" type="text" id="" value="<?php echo $_GET[endereco]; ?>" class="campos" style="width:671px;"/></b></br> 
      <b><input type="text" id="" value="<?php echo $_GET['endereco_1']; ?>" class="campos" style="width:616px" name="endereco1"/></b><span id="tex">, </span>
      <span id="tex">doravante denominado simplesmente Cirurgião-Dentista e, do outro lado </span>
      <b><input type="text" id="" name="paciente" value="<?php echo $_GET[paciente]; ?>" class="campos" style="width:283px;"/></b></br>
      <b><input type="text" id="" class="campos" name="paciente_1" value="<?php echo $_GET['paciente_1']; ?>"style="width:369px"/></b><span id="tex">,</span>
      <span id="tex">RG </span><b><input type="text" id="" name="rg_paciente" value="<?php echo $_GET[rg_paciente]; ?>" class="campos" style="width:124px"/></b><span id="tex"><span id="tex">,CPF </span>
      <b><input type="text" id="" name="cpf" class="campos" value="<?php echo $_GET[cpf]; ?>" style="width:124px"/></b>
      <span id="tex">, residente à </span><b><input name="endereco_paciente" type="text" id="" value="<?php echo $_GET['endereco_paciente']; ?>" class="campos" style="width:600px"/></b>
      <span id="tex">, doravante denominado </span>
      <span id="tex">simplesmente de paciente ou responsável pelo paciente </span><b><input name="nome_paciente" type="text" id="" value="<?php echo $_GET[nome_paciente]; ?>" class="campos" style="width:172px"/></b></br>
      <b><input type="text" id="" class="campos" name="nome_paciente1" value="<?php echo $_GET['nome_paciente1']; ?>"style="width:689px;"/></b><span id="tex">,</span></br>
      ...
      <span id="tex"><b>Cláusula Primeira –</b> Do Objetivo O objetivo do presente contrato constitui-se na prestação de serviços 
            ...
            <b>Cláusula Segunda –</b> Do Valor e Do Pagamento dos Honorários O valor  total dos honorários profissionais, relativos aos serviços 
              ...
              <b><input type="text" id="" value="<?php echo $_GET['valor']; ?>"name="valor" class="campos" style="width:162px;"/></b><span id="tex">( </span> 
              <b><input type="text" id="" name="valor_ext1" value="<?php echo $_GET['valor_ext1']; ?>"class="campos" style="width:149px;"/></b>
              <b><input type="text" id="" name="valor_ext2" value="<?php echo $_GET['valor_ext2']; ?>"class="campos" style="width:149px;"/></b><span id="tex">) </span>
             ...
             <b>Cláusula Quarta –</b> Das Obrigações do Cirurgião-Dentista O
              ...
              <b><input type="text" id="" name="horas" class="campos" value="<?php echo $_GET['horas']; ?>" style="width:72px;"/></b> 
               horas.</br> 
              ...
              <b>Cláusula Oitava -</b> Para dirimir quaisquer dúvidas sobre o presente contrato fica eleito o foro da Cidade de
                <b><input type="text" id="" value="<?php echo $_GET['foro']; ?>" name="foro" class="campos" style="width:273px;"/></b> 
