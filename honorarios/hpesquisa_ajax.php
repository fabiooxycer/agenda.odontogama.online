...
?>
    <tr bgcolor="#<?php echo $odev?>">
      <td align="left"><?php echo utf8_encode($lista[$i]['nome']);?></td>
		<td align="center"><?php echo ((verifica_nivel('honorarios', 'L'))?'<a href="javascript:Ajax(\'honorarios/honorarios\', \'conteudo\', \'codigo_convenio='.$lista[$i][codigo].'\')"><img src="imagens/icones/honorarios.gif" alt="" width="16" height="18" border="0"></a>':'')?></td>
